...
show()
def about():
        messagebox.showinfo('About E-Prescription! ','This is a application that designes medical prescription based on speech recognition and prescription can directly be sent to patient e-mail.\n-Developed by Akshay Kumar and Abhishek Negi.\n')
def guide():
